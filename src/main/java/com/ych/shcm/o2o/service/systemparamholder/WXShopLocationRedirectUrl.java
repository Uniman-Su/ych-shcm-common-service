 ...
 */
@Lazy
@Component(WXShopLocationRedirectUrl.NAME)
public class WXShopLocationRedirectUrl extends SystemParameterHolder {

    public static final String NAME = "shcm.o2o.service.systemparamholder.WXShopLocationRedirectUrl";

    public WXShopLocationRedirectUrl() {
        setKey("WXShopLocationRedirectUrl");
    }
