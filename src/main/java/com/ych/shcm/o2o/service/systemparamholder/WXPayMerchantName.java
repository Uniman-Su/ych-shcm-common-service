 ...
 */
@Lazy
@Component(WXPayMerchantName.NAME)
public class WXPayMerchantName extends SystemParameterHolder {

    public static final String NAME = "shcm.o2o.service.systemparamholder.WXPayMerchantName";

    public WXPayMerchantName() {
        setKey("WXPayMerchantName");
    }
