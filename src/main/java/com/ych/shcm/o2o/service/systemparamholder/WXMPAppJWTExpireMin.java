 ...
 */
@Lazy
@Component(WXMPAppJWTExpireMin.NAME)
public class WXMPAppJWTExpireMin extends SystemParameterHolder {

    public static final String NAME = "shcm.o2o.service.systemparamholder.WXMPAppJWTExpireMin";

    public WXMPAppJWTExpireMin() {
        setKey("WXMPAppJWTExpireMin");
    }
