 ...
 */
@Lazy
@Component(WXErrorPageUrl.NAME)
public class WXErrorPageUrl extends SystemParameterHolder {

    public static final String NAME = "shcm.o2o.service.systemparamholder.WXErrorPageUrl";

    public WXErrorPageUrl() {
        setKey("WXErrorPageUrl");
    }
