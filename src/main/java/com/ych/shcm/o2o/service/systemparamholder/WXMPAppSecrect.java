 ...
 */
@Lazy
@Component(WXMPAppSecrect.NAME)
public class WXMPAppSecrect extends SystemParameterHolder {

    public static final String NAME = "shcm.o2o.service.systemparamholder.WXMPAppSecrect";

    public WXMPAppSecrect() {
        setKey("WXMPAppSecrect");
    }
